 ...
 */
final class Version20240312153113 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE joueur CHANGE equipe_id_id equipe_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE joueur CHANGE equipe_id equipe_id_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE joueur ADD CONSTRAINT FK_FD71A9C5254808DD FOREIGN KEY (equipe_id_id) REFERENCES equipe (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
